...
export class MoviesService {
  ...
  rentMovie(history: RentHistory): Observable<Movie[]> {
    return this.http.put<Movie[]>(
      environment.apiUrl + this.moviesString + '/rent',
      history,
  ...
  updateMovie(movie: Movie): Observable<Movie[]> {
    return this.http.put<Movie[]>(
      environment.apiUrl + this.moviesString + '/edit',
      movie,
      { headers: this.service.getHeaders() }
    );
  }
  ...
  createMovie(movie: Movie): Observable<Movie[]> {
    return this.http.post<Movie[]>(
      environment.apiUrl + this.moviesString + '/add',
      movie,
      { headers: this.service.getHeaders() }
    );
  }
  ...
  deleteMovie(movie_id: number): Observable<Movie[]> {
    return this.http.delete<Movie[]>(
      environment.apiUrl + this.moviesString + `/delete/${movie_id}`,
      { headers: this.service.getHeaders() }
    );
  }
}
